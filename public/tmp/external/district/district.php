...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="<?=$url;?>/district/assets/css/style.css">
  <script src="<?=$url;?>/jquery-3.6.0.min.js"></script>
  <!--[if lte IE 10]>
        <link rel="stylesheet" href="<?=$url;?>/district/assets/css/style-for-ie9.css">
  <![endif]-->
  <script type="text/javascript" src="<?=$url;?>/district/assets/js/script.js"></script>
  ...
  <script type="text/javascript"  src="<?=$url;?>/district/blocks/content/body/body.js"></script>
  <script type="text/javascript" src="<?=$url;?>/district/blocks/content/body/__reports-title.js"></script>
  <script type="text/javascript"  src="<?=$url;?>/district/blocks/content/body/__reports.js"></script>
  <script type="text/javascript"  src="<?=$url;?>/district/blocks/content/body/__reports-footer.js"></script>
  <script type="text/javascript"  src="<?=$url;?>/district/blocks/content/content.js"></script>
  <title>Район</title>
</head>
<body>
