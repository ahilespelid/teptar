...
<head>
  ...
  <meta name="keywords" content="Список отчетов, Тептар, тептар">
    <link type="text/css" rel="stylesheet" href="<?=$url;?>/districts/assets/css/style.css">
    <script src="<?=$url;?>/jquery-3.6.0.min.js"></script>
  <script type="text/javascript" src="<?=$url;?>/districts/assets/js/script.js"></script>
  ...
  <script src="<?=$url;?>/districts/blocks/content/body/reports.js"></script>
    <script src="<?=$url;?>/districts/blocks/content/content.js"></script>
  <script src="<?=$url;?>/districts/blocks/content/body/reports-title.js"></script>
  <script src="<?=$url;?>/districts/blocks/content/body/reports-list.js"></script>
  <script src="<?=$url;?>/districts/blocks/content/body/body.js"></script>
  <script src="<?=$url;?>/districts/blocks/content/body/__footer.js"></script>
  <title>Список районов</title>
</head>
<body>

    <?php  require_once dirname(__DIR__)._DS_.'reusable-blocks'._DS_.'districts-menu'._DS_.'menu.php'; ?>
          ...
          <div class="reports-title">
            ...
            <div class="sort">
              <span class="sort__toggle">
                ...
                <img src="<?=$url;?>/districts/assets/img/svg/sort.svg">
              </span>
