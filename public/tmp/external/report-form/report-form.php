...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="<?=$url;?>/report-form/assets/css/style.css">
  ...
  <script src="<?=$url;?>/report-form/blocks/content/body/body.js"></script>
  <script src="<?=$url;?>/report-form/blocks/content/body/reports-title.js"></script>
  <script src="<?=$url;?>/report-form/blocks/content/body/reports-form.js"></script>
  <script src="<?=$url;?>/report-form/blocks/content/body/__body.js"></script>
  <script src="<?=$url;?>/report-form/blocks/content/body/__footer.js"></script>
  <script src="<?=$url;?>/report-form/blocks/content/content.js"></script>
            ...
            <div class="reports-form__body">
              ...
              <div class="reports-form__body__icons">
                ...
                <div class="reports-form__body__icon">
                  <img src="<?=$url;?>/assets/img/svg/import_light.svg">
                  Файл
                </div>
                </a>
              </div>
                ...
                <div class="reports-form__footer__first-block__element">
                  ...
                  <div class="first-block__element__worker">
                    <div class="blue-button">
                      <span>Руслан Грозный<img width="12" height="12" src="<?=$url;?>/assets/img/svg/light/rename_light.svg"></span>
                    </div>
                    <div class="clear-button">
                      <span><img width="12" height="12" src="<?=$url;?>/assets/img/svg/rename.svg">Добавить еще</span>
                    </div>
                  </div>
                </div>
                <div class="reports-form__footer__first-block__element">
                  ...
                  <div class="first-block__element__add">
                    <div class="add-button">Добавить таблицу <img src="<?=$url;?>/assets/img/svg/light/rename_light.svg"></div>
                  </div>
                </div>
              ...
              <div class="reports-form__footer__submit">
                <div class="reports-form__footer__submit__buttons">
                  <div class="add-report-btn">
                    <img src="<?=$url;?>/assets/img/svg/add_ring_light.svg">
                    Создать отчет
                  </div>
                  <div class="cancel-report-btn">
                    <img src="<?=$url;?>/assets/img/svg/rename.svg">
                    Отмена
                  </div>
                </div>
