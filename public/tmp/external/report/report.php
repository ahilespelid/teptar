...
<head>
  ...
  <meta name="description" content="Форма создания отчета">
    <link rel="stylesheet" href="<?=$url;?>/report/assets/css/style.css">
  ...
  <script type="text/javascript" src="<?=$url;?>/report/blocks/content/body/body.js"></script>
  <script type="text/javascript" src="<?=$url;?>/report/blocks/content/body/reports-title.js"></script>
  <script type="text/javascript" src="<?=$url;?>/report/blocks/content/body/__body.js"></script>
  <script type="text/javascript" src="<?=$url;?>/report/blocks/content/body/__footer.js"></script>
  <script type="text/javascript" src="<?=$url;?>/report/blocks/content/body/__side-block.js"></script>
  <script type="text/javascript" src="<?=$url;?>/report/blocks/content/content.js"></script>
            ...
            <div class="reports-body__content">
              ...
              <div class="reports-body__content__activity">
                ...
                <div class="reports-body__content__changes">
                    ...
                    <?php  require_once dirname(__DIR__)._DS_.'report'._DS_.'blocks'._DS_.'content'._DS_.'activity'._DS_.'activity.php'; ?>
