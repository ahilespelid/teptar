...
<head>
  ...
  <link rel="stylesheet" href="<?=$url;?>/reports/assets/css/style.css">
  <script src="<?=$url;?>/jquery-3.6.0.min.js"></script>
    <!--[if IE 9]>
    <link rel="stylesheet" href="./assets/css/style-for-ie9.css">
    <![endif]-->
  <script type="text/javascript" src="<?=$url;?>/reports/assets/js/reports.js"></script>
  <script type="text/javascript"  src="<?=$url;?>/reusable-blocks/menu/menu.js"></script>
  <script type="text/javascript"  src="<?=$url;?>/reusable-blocks/menu/__main.js"></script>
  <script type="text/javascript"  src="<?=$url;?>/reusable-blocks/menu/__header.js"></script>
  <script type="text/javascript"  src="<?=$url;?>/reusable-blocks/menu/__body.js"></script>
  <script type="text/javascript"  src="<?=$url;?>/reusable-blocks/menu/__footer.js"></script>
  <script type="text/javascript"  src="<?=$url;?>/reusable-blocks/header/header.js"></script>
  <script type="text/javascript"  src="<?=$url;?>/reusable-blocks/header/__main.js"></script>
    <script type="text/javascript"  src="<?=$url;?>/reports/blocks/content/body/body.js"></script>
  <script type="text/javascript" src="<?=$url;?>/reports/blocks/content/body/__reports-title.js"></script>
  <script type="text/javascript"  src="<?=$url;?>/reports/blocks/content/body/__reports.js"></script>
  <script type="text/javascript"  src="<?=$url;?>/reports/blocks/content/body/__reports-footer.js"></script>
  <script type="text/javascript"  src="<?=$url;?>/reports/blocks/content/content.js"></script>
            ...
            <div class="reports-title__my-reports">
              ...
              <div class="reports-title__my-reports__btn">
                <button class="add-report-btn">
                  <img src="<?=$url;?>/reports/assets/img/svg/add_ring_light.svg" alt="add_ring_light">
                  Добавить отчет
                </button>
              </div>
            </div>
            ...
            <div class="reports-list">
                <div style="margin-bottom: 20px;" class="reports-list__title">
                  <div class="reports-list__title__element">
                    ...
                    <img class="report-table-header-img" src="<?=$url;?>/reports/assets/img/svg/setting.svg" alt="setting">
                    Название
                  </div>
                  <div class="reports-list__title__element">
                    Эффективность
                    ...
                    <div class="reports__body__line" style="display: none;">
                        ...
                        <div class="reports__body__line__assistant">
                            <div class="name-block">
                                <img src="<?=$url;?>/reports/assets/img/avatar.jpg" class="reports__body__avatar"><span class="name"></span>
                            </div>
                        </div>
              ...
              <div class="reports-footer__action">
                ...
                <div class="reports-footer__action__sort none">
                  <div class="variables excel">
                    <img width="30" height="30" src="<?=$url;?>/reports/assets/img/svg/xlsx.svg">
                    Выгрузить в Excel
                  </div>
                  <div class="variables word">
                    <img width="30" height="30" src="<?=$url;?>/reports/assets/img/svg/word.svg">
                    Выгрузить в Word
                  </div>
                  <div class="variables pdf">
                    <img width="30" height="30" src="<?=$url;?>/reports/assets/img/svg/pdf.svg">
                    Выгрузить в PDF
                  </div>
                </div>
                <img width="24" height="24" src="<?=$url;?>/reports/assets/img/svg/arrow_drop_down_black.svg" alt="&#x2193">
              </div>
