            ...
            <div class="actions__info-item">
                ...
                <div class="actions__activity-info">
                    ...
                    <div class="status second-status">
                        ...
                        <span<?php if ($index['id_status'] === 6) { ?>class="active"<?php } ?>>
                            <i class="icon-document-update"></i> Изменено
                        </span>
                        <span<?php if ($index['id_status'] === 5) { ?>class="active"<?php } ?>>
...
<!--                      <div class="list">-->
<!--                          <div class="item">--><?//= $index['id_mark'] ?><!--</div>-->
<!--                      </div>-->
                    </div>
                    <div class="indicator-description">
                      <b><?= $index['num'] ?>.</b> <?= $index['name'] ?>
                    </div>
                    <div class="indicator-comparison">
                      <div>Было: <b>17.2</b></div>
                      <div>Стало: <b><?= $index['index'] ?></b></div>
                    </div>
                </div>
